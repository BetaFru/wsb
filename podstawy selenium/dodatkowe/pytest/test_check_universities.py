...
class WsbPlSearch(unittest.TestCase):
    ...
    def test_universities_options(self):
        ...
        # Wybierz Wrocław
        select_university.select_by_visible_text(u"Wrocław")

        WebDriverWait(self.driver, 20)\
            .until(expected_conditions.title_contains(u"Wrocław"))
        # Sprawdź, czy otworzyła się strona WSB Wrocław
        print self.driver.current_url
        self.assertTrue("wroclaw" in self.driver.current_url)
